...
export default class startScene extends Phaser.Scene {
    ...
    create(){
        ...
        */
        ...
        this.add.text(400, 200, 'Platform to reach the coin,', { fontSize: '25px', fill: '#000' }).setOrigin(0.5,0.5);
        this.add.text(400, 235, 'try to get the best time!', { fontSize: '25px', fill: '#000' }).setOrigin(0.5,0.5);
        this.add.text(400, 300, 'Direction keys to move,', { fontSize: '25px', fill: '#000' }).setOrigin(0.5,0.5);
        this.add.text(400, 335, 'space to jump. Dont get hit!', { fontSize: '25px', fill: '#000' }).setOrigin(0.5,0.5);
        this.add.text(400, 395, "F to restart if you're bad.", { fontSize: '25px', fill: '#000' }).setOrigin(0.5,0.5);

        this.add.text(400, 450, 'Press ENTER to start!', { fontSize: '35px', fill: '#000' }).setOrigin(0.5,0.5);
